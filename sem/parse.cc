// Generated by Bisonc++ V5.02.00 on Tue, 27 Nov 2018 15:13:00 +0100
...
#line 68 "while.y"
        {
         ...
         std::cout << "declared variable " << *d_vsp__[-1].name << std::endl; 
         }
        break;
...
#line 140 "while.y"
        {
         ...
         std::stringstream ss;
         ss << "asssignment to undeclared variable: " << *d_vsp__[-3].name << ".\n";
         error( ss.str().c_str() ); 
         }
...
#line 154 "while.y"
        {
         ...
         std::stringstream ss;
         ss << "read of undeclared variable: " << *d_vsp__[-2].name << ".\n";
         error( ss.str().c_str() ); 
         }
         }
        break;
...
#line 209 "while.y"
        {
         ...
         std::stringstream ss;
         ss << "use of undeclared variable in expressin: " << *d_vsp__[0].name << ".\n";
         error( ss.str().c_str() ); 
         }
         }
        break;
