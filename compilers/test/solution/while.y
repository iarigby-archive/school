...
assignment:
    singleassignment T_SEMICOLON
    {
        std::cout << "assignment -> T_ID T_ASSIGN expression T_SEMICOLON" << std::endl;
    }
|	
	multipleassignment T_SEMICOLON
	{
        std::cout << "assignment -> T_IDs T_ASSIGN expressions T_SEMICOLON" << std::endl;
    }
;

multipleassignment:
	T_ID T_ASSIGNSEP multipleassignment T_ASSIGNSEP expression
|
	singleassignment
;
...
|
    ...
    {
        std::cout << "loop -> T_REPEAT expression T_UNTIL statements T_DONE" << std::endl;
    }
|
	T_FOR T_ID T_FROM expression T_TO expression T_DO statements T_DONE
	{
        std::cout << "loop -> T_FOR T_ID T_FROM expression T_TO expression T_DO statements T_DONE" << std::endl;
    }
;
