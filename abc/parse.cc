// Generated by Bisonc++ V5.02.00 on Tue, 20 Nov 2018 14:44:33 +0100
...
PI__ const s_productionInfo[] = 
{
     ...
     {263, 3}, // 1: start ->  aseq bseq cseq
     {264, 1}, // 2: aseq (A) ->  A
     {264, 2}, // 3: aseq (A) ->  aseq A
     {265, 1}, // 4: bseq (B) ->  B
     {265, 2}, // 5: bseq (B) ->  bseq B
     {266, 1}, // 6: cseq (C) ->  C
     {266, 2}, // 7: cseq (C) ->  cseq C
     {267, 1}, // 8: start_$ ->  start
};
...
#line 20 "abc.y"
        {
         if(d_vsp__[-2].length == d_vsp__[-1].length && d_vsp__[-1].length == d_vsp__[0].length) {
         std::cout << "The sequence is valid, the length is: " << d_vsp__[-2].length << std::endl;
         } else {
...
#line 31 "abc.y"
        ...
        case 3:
#line 34 "abc.y"
        { d_val__.length = d_vsp__[-1].length + 1; }
        break;
