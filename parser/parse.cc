// Generated by Bisonc++ V4.09.02 on Tue, 09 Oct 2018 14:39:55 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {293, 1}, // 5: statements ->  statement
     {293, 2}, // 6: statements ->  statement statements
     {295, 2}, // 7: statement (T_SKIP) ->  T_SKIP T_SEMICOLON
     {295, 1}, // 8: statement ->  assignment
     {295, 1}, // 9: statement ->  read
     {295, 1}, // 10: statement ->  write
     {296, 4}, // 11: assignment (T_ID) ->  T_ID T_ASSIGN expression T_SEMICOLON
     {297, 5}, // 12: read (T_READ) ->  T_READ T_OPEN T_ID T_CLOSE T_SEMICOLON
     {298, 5}, // 13: write (T_WRITE) ->  T_WRITE T_OPEN expression T_CLOSE T_SEMICOLON
     {299, 1}, // 14: expression (T_NUM) ->  T_NUM
     {299, 1}, // 15: expression (T_TRUE) ->  T_TRUE
     {299, 1}, // 16: expression (T_FALSE) ->  T_FALSE
     {299, 1}, // 17: expression (T_ID) ->  T_ID
     {299, 3}, // 18: expression (T_ADD) ->  expression T_ADD expression
     {299, 2}, // 19: expression (T_NOT) ->  T_NOT expression
     {299, 3}, // 20: expression (T_OPEN) ->  T_OPEN expression T_CLOSE
     {300, 1}, // 21: program_$ ->  program
};
