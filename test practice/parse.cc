// Generated by Bisonc++ V4.09.02 on Tue, 16 Oct 2018 14:52:26 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {297, 5}, // 14: statement (T_REPEAT) ->  T_REPEAT statement T_UNTIL expression T_DONE
     {298, 4}, // 15: assignment (T_ID) ->  T_ID T_ASSIGN expression T_SEMICOLON
     {299, 5}, // 16: read (T_READ) ->  T_READ T_OPEN T_ID T_CLOSE T_SEMICOLON
     {300, 5}, // 17: write (T_WRITE) ->  T_WRITE T_OPEN expression T_CLOSE T_SEMICOLON
     {301, 5}, // 18: branch (T_IF) ->  T_IF expression T_THEN statements T_ENDIF
     {301, 7}, // 19: branch (T_IF) ->  T_IF expression T_THEN statements T_ELSE statements T_ENDIF
     {302, 5}, // 20: loop (T_WHILE) ->  T_WHILE expression T_DO statements T_DONE
